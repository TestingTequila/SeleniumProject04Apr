...
public class LoginWithTestNg {
    ...
    @Test(priority = 3, dependsOnMethods = "login3", groups = "smoke")
    public  void login1()
    {
    ...
    @Test(priority = 1, enabled = true, timeOut = 2, groups = "smoke")
    public  void login2()
    {
        // 3- Click on My Account icon
        YourStore ys = new YourStore(driver);
    ...
    @Test(priority = 2, invocationCount = 1, groups = "sanity")
    public  void login3()
    {
        // 3- Click on My Account icon
        YourStore ys = new YourStore(driver);
